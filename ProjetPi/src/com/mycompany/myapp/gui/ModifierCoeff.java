 ...
 * @author dell
 */
public class ModifierCoeff extends Form {
    ...
    public ModifierCoeff(Form previous,Coeff t) {
        setTitle("Modifier coefficient ");
        ...
        TextField valeur = new TextField("", "Valeur");
         ...
         valeur.setText(Integer.toString(t.getValeur()));
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((valeur.getText().length() == 0)) {
                    ...
                    try {
                        ...
                        if (checkC(t) == false) {
                            if (ServiceCoeff.getInstance().updateCoeff(t)) {
                                Dialog.show("Success", "Coefficient modifié avec succès", new Command("OK"));
