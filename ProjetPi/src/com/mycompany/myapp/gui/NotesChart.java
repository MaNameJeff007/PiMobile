...
public class NotesChart extends AbstractDemoChart {
  ...
  public Form execute() 
  {     
    ArrayList<Note> tab=NoteService.getInstance().getNotesStats(NotesEleveForm.eleveNote, NotesEleveForm.matiereNote, NotesEleveForm.typeNote); 
    ...
    for(int i=0;i<tab.size();i++)
    {
        v[i]=tab.get(i).getValeur();
    }
        
    String[] titles = new String[] {NotesEleveForm.nomMatiereNote};
    ...
    setChartSettings(renderer, "", "Trimestre", "Note", 1, 3, 0, 20,
    ...
    */
    ...
    return wrap(NotesEleveForm.typeNote, c);   
  }
}
